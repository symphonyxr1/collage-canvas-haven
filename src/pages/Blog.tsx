  ...
  return (
    <div className="min-h-screen bg-richBlack relative overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: "url('/lovable-uploads/558eb843-5184-4e2f-9c3d-9e6660ca850a.png')",
      ...
      <div className="relative z-10 container mx-auto px-4 pt-32">
        {/* Page Title */}
        <h1 className="text-5xl md:text-6xl font-playfair font-bold bg-gradient-to-r from-[#e6b980] to-[#eacda3] text-transparent bg-clip-text mb-12 text-center">
          Blog
        </h1>
